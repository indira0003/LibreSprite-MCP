...
SAFE_OPERATIONS = {
    "health", "get_sprite_info", "get_active_frame", "set_active_frame",
    "get_frames", "get_layers", "add_frame", "insert_frame", "duplicate_frame",
    "delete_frame", "get_frame_durations", "set_frame_duration",
    "set_frame_durations", "create_layer", "delete_layer", "rename_layer",
    "set_layer_visibility", "set_active_layer", "get_cel", "copy_cel",
    "move_cel", "clear_cel", "get_pixel", "get_pixels", "draw_pixels",
    "get_region", "set_region", "copy_region", "move_region", "clear_region",
    "flip_region", "get_image_data", "set_image_data", "get_palette",
    "set_palette_color", "get_tags", "create_tag", "delete_tag",
    "render_frame_preview", "export_png", "export_gif", "export_spritesheet",
    "save_sprite", "save_as", "open_sprite"
}
